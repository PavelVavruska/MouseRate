...
public class MouseDrag implements MouseListener, Runnable {
	...
	/**
	 * Calculates the <b>distance<b> between <b>original</b> Mouse position (when mouse button was pressed) and position <b>right now</b>. Then inverts the results for bot x and y axis.<br/>
	...
	private void drag(){
		...
		int distanceX, distanceY;
			...
			finalPoint = new Point(originalFramePos.x + distanceX, originalFramePos.y + distanceY);
