...
public class Settings {
    ...
    private static final Color bgColor = new Color(30, 0, 255);
    private static Font mouseFont = null;

    private static final ImageIcon appIcon = new ImageIcon(Settings.class
            .getClass().getResource("/cz/pscheidl/mouse/files/mouseIcon.png"));
